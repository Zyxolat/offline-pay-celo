...
const toastVariants = {
  default: "",
  destructive: "toast-root--destructive",
} as const;
...
>(({ className, variant = "default", ...props }, ref) => {
  return <ToastPrimitives.Root ref={ref} className={cn("toast-root", toastVariants[variant], className)} {...props} />;
});
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Action ref={ref} className={cn("button button--outline button--sm toast-action", className)} {...props} />
));
