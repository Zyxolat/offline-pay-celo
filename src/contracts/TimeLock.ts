...
export const TIMELOCK_ABI = [
  ...
  "function payments(uint256) view returns (address sender, address recipient, uint256 amount, bool claimed, bool refunded)",
  "function createPayment(address recipient, uint256 duration) payable returns (uint256)",
  "function createPayment(address recipient) payable returns (uint256)",
